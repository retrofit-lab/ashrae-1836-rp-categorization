...
# Or a custom EEM list



### Step 2: Pre-processing

## Tokenize tags and count the range of number of tokens in the categorization tag list
...
# Categorizing EEMs according to the 1836-RP standardized categorization system
...
## Metric 1: Percentage of EEMs getting tagged
